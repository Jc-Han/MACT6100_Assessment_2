...
0.847 and a test AUC of 0.852. The close agreement between training and test AUC
indicates strong generalisation and no obvious evidence of overfitting, suggesting 
that the model is reliable for predicting customer churn. It is sensible to use
GLM model as baseline model for churn prediction.
